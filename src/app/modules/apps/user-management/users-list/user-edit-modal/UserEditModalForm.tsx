...
import {isNotEmpty, toAbsoluteUrl} from '../../../../../(pages)/(admin)/helpers'
            ...
            <div className='d-flex fv-row'>
              ...
              <div className='form-check form-check-custom form-check-solid'>
                ...
                <label className='form-check-label' htmlFor='kt_modal_update_role_option_2'>
                  ...
                  <div className='text-gray-600'>
                    Best for people who need full access to analytics data, but need to update
                    business settings
                  </div>
                </label>
                {/* end::Label */}
            ...
            <div className='d-flex fv-row'>
              ...
              <div className='form-check form-check-custom form-check-solid'>
                ...
                <label className='form-check-label' htmlFor='kt_modal_update_role_option_4'>
                  ...
                  <div className='text-gray-600'>
                    Best for people who need to preview content data, but need to make any
                    updates
                  </div>
                </label>
                {/* end::Label */}
